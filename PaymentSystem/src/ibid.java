 ...
 */
// this method is a copy of the ibid I/O methods available in the textbook
// it allows the input an storage of user defined variables and initialises the output method
//it also throws an I/O Exception when there is a failure in accepting the variables. 

public final class ibid
{
